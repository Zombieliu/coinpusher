...
import { ReqRegisterRoomServer, ResRegisterRoomServer } from './match/admin/PtlRegisterRoomServer';
import { ReqReportRoomStatus, ResReportRoomStatus } from './match/admin/PtlReportRoomStatus';
...
export interface ServiceType {
    api: {
        ...
        "admin/ReportRoomStatus": {
            req: ReqReportRoomStatus,
            res: ResReportRoomStatus
        },
...
export const serviceProto: ServiceProto<ServiceType> = {
    ...
    "types": {
        ...
        "admin/PtlReportRoomStatus/ReqReportRoomStatus": {
            "type": "Interface",
            "extends": [
                {
                    "id": 0,
        ...
        "admin/PtlReportRoomStatus/ResReportRoomStatus": {
            "type": "Interface",
            "extends": [
                {
                    "id": 0,
