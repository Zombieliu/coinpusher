...
import { MsgCoinCollected } from './room/game/MsgCoinCollected';
import { MsgSyncPhysics } from './room/game/MsgSyncPhysics';
import { ReqDropCoin, ResDropCoin } from './room/game/PtlDropCoin';
import { ReqPing, ResPing } from './room/game/PtlPing';
...
import { MsgBigPrizeAnnouncement } from './room/server/MsgBigPrizeAnnouncement';
...
export interface ServiceType {
    ...
    msg: {
        ...
        "game/CoinCollected": MsgCoinCollected,
        "game/SyncPhysics": MsgSyncPhysics,
        "server/BigPrizeAnnouncement": MsgBigPrizeAnnouncement,
        "server/Chat": MsgChat,
...
export const serviceProto: ServiceProto<ServiceType> = {
    ...
    "services": [
        ...
        {
            "id": 32,
            "name": "game/CoinCollected",
            "type": "msg"
        },
        {
            "id": 33,
            "name": "game/SyncPhysics",
            "type": "msg"
        },
        {
            "id": 34,
        ...
        {
            "id": 36,
            "name": "server/BigPrizeAnnouncement",
            "type": "msg"
        },
        {
            "id": 17,
    ...
    "types": {
        ...
        "game/MsgCoinCollected/MsgCoinCollected": {
            "type": "Interface",
            "properties": [
                {
                    "id": 0,
        ...
        "game/MsgSyncPhysics/MsgSyncPhysics": {
            "type": "Interface",
            "properties": [
                {
                    "id": 2,
        ...
        "server/MsgBigPrizeAnnouncement/MsgBigPrizeAnnouncement": {
            "type": "Interface",
            "extends": [
                {
                    "id": 0,
